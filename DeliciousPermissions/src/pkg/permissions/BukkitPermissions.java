...
public class BukkitPermissions {
	...
	protected DeliciousPermissions plugin;
	...
	public BukkitPermissions(DeliciousPermissions plugin) {
		...
		DeliciousPermissions.logger.info("Superperms support enabled.");
	}
	...
	public void updatePermissions(Player player, String world) {
		...
		if (player == null || !DeliciousPermissions.isLoaded()) {
			return;
		}
		...
		DeliciousPermissions.logger.finest("Attachment updated for: " + name);
	}
	...
	private List<String> sort(List<String> permList) {
		...
		for (String key : permList) {
			...
			if (!key.isEmpty()) {
				...
				Map<String, Boolean> allchildren = DeliciousPermissions.BukkitPermissions.getAllChildren(a, new HashSet<String>());
				if (allchildren != null) {
	...
	protected class PlayerEvents implements Listener {
		...
		public void onPlayerJoin(PlayerJoinEvent event) {
			...
			DeliciousPermissions.logger.finest("Player Join event: " + player.getName());
