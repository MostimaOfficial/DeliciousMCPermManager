...
import pkg.events.DPGroupEvent.Action;
...
public class Group extends DataUnit implements Cloneable {
	...
	public void addInherits(Group inherit) {
		...
		if (!isGlobal()) {
			...
			if (DeliciousPermissions.isLoaded()) {
				...
				DeliciousPermissions.getGMEventHandler().callEvent(this, Action.GROUP_INHERITANCE_CHANGED);
			}
		}
	}
	...
	public void setVariables(Map<String, Object> varList) {
		...
		if (!isGlobal()) {
			...
			if (DeliciousPermissions.isLoaded()) {
				DeliciousPermissions.BukkitPermissions.updateAllPlayers();
				DeliciousPermissions.getGMEventHandler().callEvent(this, Action.GROUP_INFO_CHANGED);
			}
		}
	}
}
