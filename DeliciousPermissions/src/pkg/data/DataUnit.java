...
import pkg.utils.StringPermissionComparator;
...
public abstract class DataUnit {
	...
	public void flagAsChanged() {
		...
		DeliciousPermissions.logger.finest("DataSource: " + source + " - DataUnit: " + getUUID() + " flagged as changed!");
	...
	public void flagAsSaved() {
		...
		DeliciousPermissions.logger.finest("DataSource: " + source + " - DataUnit: " + getUUID() + " flagged as saved!");
		changed = false;
	}
